...
class Data_holder:
    ...
    def __init__(self):
        ...
        self.in_path = "C:\\Users\\Administrator\\Desktop\\qadataset\\dev-v1.1.json"
    ...
    def get_next_batch(self):
        ...
        para_length = numpy.zeros((cur_batch), dtype=numpy.int32)
        ...
        for i in range(self.Batch_Index, self.Batch_Index + cur_batch):
            ...
            para_length[index] = int(self.Paragraphs_Length[self.argsort_length[i]])
        ...
        return batch_paragraph, batch_question, batch_start_index, batch_stop_index, batch_start_index_value, batch_stop_index_value, batch_IDs, isEnd, para_length